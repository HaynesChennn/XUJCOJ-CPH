...
(function () {
    ...
    var navbar = document.getElementsByClassName("navbar-right")[0]; //getElementsByClassName 返回的是数组，所以要用[] 下标
